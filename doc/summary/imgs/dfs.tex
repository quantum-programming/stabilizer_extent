...
\begin{document}
\begin{tikzpicture}[
        myBlock1/.style={draw=cA,fill=cA!50,ultra thick},
        myBlock2/.style={draw=cB,fill=cB!50,ultra thick},
        myBlock3/.style={draw=cC,fill=cC!50,ultra thick},
    ...
    Evaluate: \\[0.9em]
    ${\displaystyle \max_{c,Q}\qty{\abs{\sum_{x=0}^{2^n-1} -1^{x^\top Q x} i^{c^\top x} P_x}}}$
    };
