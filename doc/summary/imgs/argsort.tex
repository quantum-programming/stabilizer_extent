    ...
    \foreach \x/\y/\ar/\ai/\br/\bi/\cr/\ci/\dr/\di/\alpha in {
            ...
            \ifthenelse{\x=0}{
                \begin{scope}[yshift=\y cm]
                    \node[anchor=center,cA!\alpha] at (\ar*1.4,\ai*1.4) {$b_{00}$};
                    \node[anchor=center,cB!\alpha] at (\br*1.4,\bi*1.4) {$b_{01}$};
                    \node[anchor=center,cC!\alpha] at (\cr*1.4,\ci*1.4) {$b_{10}$};
                    \node[anchor=center,cD!\alpha] at (\dr*1.4,\di*1.4) {$b_{11}$};
                \end{scope}
            }{}
